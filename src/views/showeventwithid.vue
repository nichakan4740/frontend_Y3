...
onBeforeMount(async () => {
  ...
  const file = await fetch(`${import.meta.env.VITE_BASE_URL}api/files/` + params.eventid,{
    method: "GET",
    mode: "cors",
    // headers: {
    //   'Authorization' : "Bearer " + localStorage.getItem('accesstoken'),
  ...
  const ress = await fetch(`${import.meta.env.VITE_BASE_URL}api/events/` + params.eventid,{
    method: "GET",
    mode: "cors",
    headers: {
  ...
  if (ress.status === 200) {
    eventwithid.value = await ress.json();
    console.log(eventwithid.value)
  } 
}
});
...
const res = await fetch(`${import.meta.env.VITE_BASE_URL}api/files/` + params.eventid +`/`+ filewithid.value,{
 method: "GET",
 mode: "cors",
 // headers: {
 //   'Authorization' : "Bearer " + localStorage.getItem('accesstoken'),
...
<div class="courses-container">
	<div class="course">
      ...
      <a class="file" v-for="file in filewithid" @click="loadfile()" > 
        <svg id="file" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-paperclip" viewBox="0 0 16 16" color="black">
          <path d="M4.5 3a2.5 2.5 0 0 1 5 0v9a1.5 1.5 0 0 1-3 0V5a.5.5 0 0 1 1 0v7a.5.5 0 0 0 1 0V3a1.5 1.5 0 1 0-3 0v9a2.5 2.5 0 0 0 5 0V5a.5.5 0 0 1 1 0v7a3.5 3.5 0 1 1-7 0V3z"/>
        </svg>
        <!-- <span class="fileat" >Attachment</span>  -->
      {{ file }} 
      <span class="showdownloadfile">Download</span>
    </a>
...
.showdownloadfile {
  ...
  font-size: 10px;
  letter-spacing: 1px;
  background-color: rgba(187, 187, 187, 0.616);
