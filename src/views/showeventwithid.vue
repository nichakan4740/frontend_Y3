...
onBeforeMount(async () => {
  const res = await fetch(
    `${import.meta.env.VITE_BASE_URL}api/events/` + params.eventid,
    {
      method: "GET",
      mode: "cors",
      headers: {
  ...
  const file = await fetch(
    `${import.meta.env.VITE_BASE_URL}api/files/` + params.eventid,
    {
      method: "GET",
      mode: "cors",
      headers: {
  ...
  <div class="courses-container">
    <div class="course">
      <div class="course-preview">
        ...
        <a>
          {{ eventwithid.eventDuration }} minute
      ...
      <div class="course-info">
        ...
        <h6>
          {{ moment(eventwithid.eventStartTime).format("DD MMM YYYY, HH:mm") }}
        </h6>
        <p class="name">{{ eventwithid.bookingName }}</p>
        <p class="email">
          {{ eventwithid.eventEmail
          }}<span v-if="eventwithid.eventEmail === null" class="noemail"
            >no email</span
          >
        </p>
        <p class="note">
          {{ eventwithid.eventNotes
          }}<span v-if="eventwithid.eventNotes === null" class="nonote"
            >no message</span
          >
        </p>
