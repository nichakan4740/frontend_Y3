        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li
                v-show="
                  role === 'admin' || role === 'student' || role === 'lecturer'
                "
              >
                <a
              ...
              <li v-show="role === 'admin' || role === 'student'">
                <a
              ...
              <li
                ...
                "
              >
                <a @click="deletetoken" id="active_logout">
              ...
              <li v-show="role === null">
                <a class="active_signin"
                  ><router-link :to="{ name: 'login' }" id="active_signin"
                    >Sign in</router-link
                  ></a
                >
              </li>
              ...
              <li v-show="role === null">
                <a class="active_signup"
                  ><router-link :to="{ name: 'adduser' }" id="active_signup"
                    >Sing up</router-link
                  ></a
                >
              </li>
          ...
          <div
            class="username"
            v-show="
              role === 'student' || role === 'admin' || role === 'lecturer'
            "
          >
            <ul class="nav">
